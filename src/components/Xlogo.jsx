...
const Xlogo = () => {
  return (
    <div className="x-logo pl-2 hover:cursor-pointer w-fit   flex justify-start ">
      <svg
        viewBox="0 0 24 24"
        aria-hidden="true"
        className="w-7   r-4qtqp9 r-yyyyoo r-dnmrzs r-bnwqim r-lrvibr r-m6rgpd r-lrsllp r-1nao33i r-16y2uox r-8kz0gk"
      >
        <g>
          <path
            fill="currentColor"
